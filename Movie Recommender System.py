...
df = pd.read_csv("D:\Downloads\Movie-Recommendation-System-Using-Python-and-Pandas-master\Movie-Recommendation-System-Using-Python-and-Pandas-master\dataset.csv", sep = '\t', names = column_names)
df.head()
...
movie_titles = pd.read_csv("D:\Downloads\Movie-Recommendation-System-Using-Python-and-Pandas-master\Movie-Recommendation-System-Using-Python-and-Pandas-master\movieIdTitles.csv")
movie_titles.head()
...
ratings.to_csv("D:\Downloads\Movie-Recommendation-System-Using-Python-and-Pandas-master\Movie-Recommendation-System-Using-Python-and-Pandas-master\MovieRecommendations.csv", encoding='utf-8')
...
df_result = pd.read_csv("D:\Downloads\Movie-Recommendation-System-Using-Python-and-Pandas-master\Movie-Recommendation-System-Using-Python-and-Pandas-master\MovieRecommendations.csv")
df_result.head()
